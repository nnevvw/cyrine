...
export const projects = [
  ...
  },
  {
    ...
    fr: {
      ...
      tagline: "Projet en cours d'intégration",
      role: "Projet data",
      summary:
        "Ce projet n'est pas encore branché sur le portfolio : le dépôt n'était pas disponible en local au moment de la refonte. Le gabarit est prêt — dès que le code est là, la fiche se remplit comme celle de JOJA.",
      highlights: [],
      finding: null,
      findingLabel: null,
    },
    en: {
      title: "Alice in Borderland",
      tagline: "Being wired in",
      role: "Data project",
      summary:
        "This project is not plugged into the portfolio yet: the repository wasn't available locally during the redesign. The template is ready — as soon as the code is here, this card fills in like JOJA's.",
      highlights: [],
      finding: null,
      findingLabel: null,
    },
...
export const ui = {
  fr: {
    ...
    navContact: "Contact",
    workTitle: "Projets",
    workLead: "Deux projets data en tête, le reste de mon parcours web juste en dessous.",
    featuredLabel: "Projet data",
    filterAll: "Tout",
    otherWorkTitle: "Avant la data — le web",
    otherWorkLead: "Trois ans de projets front-end, no-code et gestion de projet. C'est là que j'ai appris à livrer.",
  ...
  en: {
    ...
    navContact: "Contact",
    workTitle: "Work",
    workLead: "Two data projects up front, the rest of my web background just below.",
    featuredLabel: "Data project",
    filterAll: "All",
    otherWorkTitle: "Before data — the web",
    otherWorkLead: "Three years of front-end, no-code and project management. This is where I learned to ship.",
    readMore: "Read more",
    close: "Close",
    liveSite: "Visit site",
    viewCode: "View code",
